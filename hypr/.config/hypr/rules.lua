...
rule({ name = "windowrule-4", opacity = "0.85 0.95", match = { class = "^(org.gnome.Nautilus)$" } })
...
rule({ name = "windowrule-9", min_size = { 1850, 1000 }, max_size = { 1850, 1000 }, center = true, match = { class = "^(chromium)$", float = true } })
